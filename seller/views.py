...
from notifi.models import BroadcastNotifications
from buysellproject.settings import EMAIL_HOST_USER
import json
...
class Userhome(View):
    def get(self,request):
        ...
        return render(request, 'seller/userhome.html', {'products' : product,  'room_name' : request.user.username })
